...
import { Grid, makeStyles, Button, Typography, useTheme, useMediaQuery, Card, CardContent } from '@material-ui/core'
...
const LandingPage = (props) => {
    ...
    return (
        <Grid container direction="column" className={classes.mainContainer}>
                ...
                <Grid container justifyContent="flex-end" alignItems="center" direction="row">
                    <Grid sm item className={classes.heroTextContainer} >
                        ...
                        <Grid container justifyContent="center" className={classes.buttonContainer}>
                            ...
                            <Grid item>
                                <Button onClick={() => props.setValue(2)} component={Link} to="/revolution" variant="outlined" className={classes.learnButtonHero}><span style={{ marginRight: 10 }}>Learn More</span>
                    ...
                    <Card className={classes.revolutionCard}>
                        <CardContent>
                            <Grid container direction="column" style={{ textAlign: 'center' }}>
                                ...
                                <Grid item>
                                    <Typography variant="subtitile1">Visionary insights coupled with cutting-edge technology is a recipe for revolution. </Typography>
                                    <br />
                                    <Button onClick={() => props.setValue(2)} component={Link} to="/revolution" variant="outlined" className={classes.learnButtonHero}><span style={{ marginRight: 10 }}>Learn More</span>
                                        <ButtonArrow width="15" height="15" fill={theme.palette.common.blue} />
                                    </Button>
            ...
            {/* -------Information Block------------ */}
            <Grid item>
                <Grid container className={classes.infoBackground} style={{ height: '80em' }} alignItems="center" direction="row">
                    <Grid container style={{ position: 'absolute', textAlign: matchesXS ? 'center' : 'inherit' }} direction={matchesXS ? 'column' : 'row'} >
                        <Grid sm item style={{ marginLeft: matchesXS ? 0 : matchesSM ? '2em' : '5em', marginBottom: matchesXS ? '10em' : 0  }}>
                            <Grid container direction="column">
                                <Typography variant="h2" style={{ color: 'white' }}>About Us</Typography>
                                <Typography variant="subtitle2">Let's get personal.</Typography>
                                <Grid item>
                                    <Button onClick={() => props.setValue(3)} component={Link} to="/about" variant="outlined" className={classes.learnButton} style={{ color: 'white', borderColor: 'white' }}>
                                        <span style={{ marginRight: 10 }}>Learn More</span>
                        ...
                        <Grid sm item style={{ marginRight: matchesXS ? 0 : matchesSM ? '2em' : '5em', textAlign: matchesXS ? 'center' : 'right' }}>
                            <Grid container direction="column">
                                ...
                                <Grid item>
                                    <Button onClick={() => props.setValue(4)} component={Link} to="/contact" variant="outlined" className={classes.learnButton} style={{ color: 'white', borderColor: 'white' }}>
                                        <span style={{ marginRight: 10 }}>Learn More</span>
                                        <ButtonArrow width="10" height="10" fill='white' />
                                    </Button>
                                </Grid>
